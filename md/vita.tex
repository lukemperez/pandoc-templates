...
%%     \usepackage{fontspec}
%%   \fi
%%   \defaultfontfeatures{oLigatures=TeX,Scale=MatchLowercase}
...
\predate{\begin{center}\small\scshape\sffamily\vspace{-2em}}
\postdate{\par\end{center}}

% Custom Section Headers
% \let\paragraph\oldparagraph
% \let\articlesubparagraph\subparagraph
...
% Now we set the spacing in the section headers:
\titlespacing{\section}{0pt}{1.5\parskip}{\parskip} % {\baselineskip}{-.05em}
\titlespacing{\subsection}{0pt}{\parskip}{-.05em}
